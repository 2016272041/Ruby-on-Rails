...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { companyid: @register.companyid, companyname: @register.companyname, contact: @register.contact, email: @register.email, service: @register.service } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { companyid: @register.companyid, companyname: @register.companyname, contact: @register.contact, email: @register.email, service: @register.service } }
